<div class="flex mt-4 w-full">
    <div class="m-auto w-auto flex gap-x-4">
        <a href="{{ route('dashboard') }}" class="w-[24vw]">
        ...
        <a href="{{ route('categories.index') }}" class="w-[24vw]">
        ...
        <a href="{{ route('announcements.index') }}" class="w-[24vw]">
        ...
        <a href="{{ route('suppliers.index') }}" class="w-[24vw]">
