    ...
    <!-- Services modal -->
      <div id="modal" class="hidden fixed z-20 top-0 left-0 h-screen w-screen bg-transparent justify-center backdrop-blur-md items-center p-4">
          <div class="relative block left-1/2 top-1/2 border border-gray border-opacity-50 transform -translate-x-1/2 -translate-y-1/2 w-1/2 h-1/2 bg-white shadow-2xl p-8 rounded">
              <img id="modalImg" src="{{ asset('images/products/placeholder.png') }}" class="w-40 my-4 shadow-md mx-auto">
              <p id="modalContText">
          ...
          <div class="flex flex-wrap justify-center items-center gap-20 mt-20"> 
            ...
            <div class="group bg-notwhite w-80 h-72 relative flex flex-col items-center justify-center gap-2 text-center shadow-lg rounded-2xl overflow-hidden duration-300">
              ...
              <div class="w-28 h-28 mt-8 rounded-full bg-transparent z-10 transition-all duration-500">
                <img src="{{ asset('images/categories/supplies.png') }}" class="w-full rounded-full mx-auto" alt="service icon">
              </div>
              <div class="block z-10 px-0 transition-all duration-500">
                <h1 class="text-2xl font-semibold">School Supplies</h1>
                <p id="suppliesText" class="hidden">Notebook, Pens, Folders, Tape, File organizer, Calculator, Uniform, etc.</p>
            ...
            <div class="group bg-notwhite w-80 h-72 relative flex flex-col items-center justify-center gap-2 text-center shadow-lg rounded-2xl overflow-hidden duration-300">
              <!-- circle -->
              <div class="w-28 h-28 mt-8 rounded-full bg-transparent z-10 transition-all duration-500">
                <img src="{{ asset('images/categories/cctv.png') }}" class="w-full rounded-full mx-auto" alt="service icon">
              </div>
              <div class="block z-10 px-0 transition-all duration-500">
            ...
            <div class="group bg-notwhite w-80 h-72 relative flex flex-col items-center justify-center gap-2 text-center shadow-lg rounded-2xl overflow-hidden duration-300">
              <!-- circle -->
              <div class="w-28 h-28 mt-8 rounded-full bg-transparent z-10 transition-all duration-500">
                <img src="{{ asset('images/categories/appliances.png') }}" class="w-full rounded-full mx-auto" alt="service icon">
              </div>
              <div class="block z-10 px-0 transition-all duration-500">
            ...
            <div class="group bg-notwhite w-80 h-72 relative flex flex-col items-center justify-center gap-2 text-center shadow-lg rounded-2xl overflow-hidden duration-300">
              <!-- circle -->
              <div class="w-28 h-28 mt-8 rounded-full bg-transparent z-10 transition-all duration-500">
                <img src="{{ asset('images/categories/agriculture.png') }}" class="w-full rounded-full mx-auto" alt="service icon">
              </div>
              <div class="block z-10 px-0 transition-all duration-500">
            ...
            <div class="group bg-notwhite w-80 h-72 relative flex flex-col items-center justify-center gap-2 text-center shadow-lg rounded-2xl overflow-hidden duration-300">
              <!-- circle -->
              <div class="w-28 h-28 mt-8 rounded-full bg-transparent z-10 transition-all duration-500">
                <img src="{{ asset('images/categories/ict.png') }}" class="w-full rounded-full mx-auto" alt="service icon">
              </div>
              <div class="block z-10 px-0 transition-all duration-500">
            ...
            <div class="group bg-notwhite w-80 h-72 relative flex flex-col items-center justify-center gap-2 text-center shadow-lg rounded-2xl overflow-hidden duration-300">
              <!-- circle -->
              <div class="w-28 h-28 mt-8 rounded-full bg-transparent z-10 transition-all duration-500">
                <img src="{{ asset('images/categories/lighting.png') }}" class="w-full rounded-full mx-auto" alt="service icon">
              </div>
              <div class="block z-10 px-0 transition-all duration-500">
            ...
            <div class="group bg-notwhite w-80 h-72 relative flex flex-col items-center justify-center gap-2 text-center shadow-lg rounded-2xl overflow-hidden duration-300">
              <!-- circle -->
              <div class="w-28 h-28 mt-8 rounded-full bg-transparent z-10 transition-all duration-500">
                <img src="{{ asset('images/categories/it.png') }}" class="w-full rounded-full mx-auto" alt="service icon">
              </div>
              <div class="block z-10 px-0 transition-all duration-500">
            ...
            <div class="group bg-notwhite w-80 h-72 relative flex flex-col items-center justify-center gap-2 text-center shadow-lg rounded-2xl overflow-hidden duration-300">
              <!-- circle -->
              <div class="w-28 h-28 mt-8 rounded-full bg-transparent z-10 transition-all duration-500">
                <img src="{{ asset('images/categories/electrical.png') }}" class="w-full rounded-full mx-auto" alt="service icon">
              </div>
              <div class="block z-10 px-0 transition-all duration-500">
                <h1 class="text-2xl font-semibold">Electronics & Electrical Supplies</h1>
                <p id="electricalText" class="hidden">Solar Panel System, Switch, Fuse Connectors, Lamp holder, Junction Box, Vehicle parts, etc.</p>
            ...
            <div class="group bg-notwhite w-80 h-72 relative flex flex-col items-center justify-center gap-2 text-center shadow-lg rounded-2xl overflow-hidden duration-300">
              <!-- circle -->
              <div class="w-28 h-28 mt-8 rounded-full bg-transparent z-10 transition-all duration-500">
                <img src="{{ asset('images/categories/logistics.png') }}" class="w-full rounded-full mx-auto" alt="service icon">
              </div>
              <div class="block z-10 px-0 transition-all duration-500">
