            ...
            <div class="flex w-3/4">
                <div class="block justify-center px-32 m-auto">
                    ...
                    <div class="flex flex-wrap justify-center mt-12 gap-x-2 gap-y-6">
                        ...
                        <button onclick="window.location.href='/sng/cso'" class="pl-4 w-[48%] pr-24 text-left py-2 text-black font-bold text-lg rounded-full shadow-lg transition-transform transform bg-transparent border-opacity-50 hover:border-2 border-white hover:scale-105 hover:border-gray hover:shadow-black hover:shadow-2xl focus:outline-none">
                        Corporate Structure Overview
                        </button>
                        
                        <button onclick="window.location.href='/sng/cg'" class="pl-4 w-[48%] pr-24 text-left py-2 text-black font-bold text-lg rounded-full shadow-lg transition-transform transform bg-transparent border-opacity-50 hover:border-2 border-white hover:scale-105 hover:border-gray hover:shadow-black hover:shadow-2xl focus:outline-none">
